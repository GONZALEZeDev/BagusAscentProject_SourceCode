...
public class NyamaScript : Ennemies
{
    ...
    void Start()
    {
        ...
        currentSkills.Add(new KaboomAttack());
    }
    ...
    void Attacking()
    {
        ...
        else if (skillSelected.SkillName == "Kaboom")
        {
            KaboomAttack kaboom = new KaboomAttack();
            kaboom.ActivateAttackEffect(this, TeamClass.instance.heroTeam);
            announcementText = this.characterName + " uses " + skillSelected.SkillName + ", all heroes are hit and burned !";
            StartCoroutine(ButtonUIFight.instance.DisplayAnnouncement(announcementText));
        }
        else if (skillSelected.SkillName == "Strike")
        {
            skillSelected.ActivateAttackEffect(this, mainTarget);
            announcementText = this.characterName + " uses " + skillSelected.SkillName + " on " + mainTarget.characterName + " !";
            StartCoroutine(ButtonUIFight.instance.DisplayAnnouncement(announcementText));
