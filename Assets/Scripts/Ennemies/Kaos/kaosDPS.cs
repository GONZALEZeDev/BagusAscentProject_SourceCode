...
public class KaosDPS : Ennemies
{
    ...
    void Update()
    {
        ...
        if ((currentMana < maxMana/2 && !isblocking && !hasBlocked) || Random.Range(1, 5) == 4)
        {
            Blocking(); 
        }
    ...
    void Attacking()
    {
        ...
        else if (skillSelected.SkillName == "Sharpened Weapon")
        {
            skillSelected.ActivateAttackEffect(this, mainTarget);
        ...
        else if (skillSelected.SkillName == "Heating Weapon")
        {
            skillSelected.ActivateAttackEffect(this, mainTarget);
